class WarCardGame:
    ...
    def __init__(self,player,computer,deck):
        ...
        self.make_initial_decks() #when create a instance, automatically make initial deck 
    ...
    def start_war(self,cards_from_battle):
        ...
        for i in range(3):
            player_card = self.player.draw_card()
    ...
    def print_stats(self):
        print("\n----")
        print(f"You have {self._player.deck.size} cards on your deck. ") # deck attribute from player class / size method from deck class
